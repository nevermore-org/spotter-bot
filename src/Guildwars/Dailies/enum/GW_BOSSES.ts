...
const GW_BOSSES: DailyData = {
    ...
    "Demolisher": {
        waypoint: "The Darklands Waypoint",
        chatcode: "[&BKMKAAA=]",
        description: "",
        schedule: [
            "1:00",
    ...
    "Hound_Master": {
        waypoint: "Vehjin Palace Waypoint",
        chatcode: "[&BO0KAAA=]",
        description: "",
        schedule: [
            "0:00",
